...
begin
    ...
    begin
        case(read_state)
        IDLE : begin
            if(total_pixel_counter >= IMAGE_WIDTH * KERNEL_SIZE)
            begin
...
begin
    case(current_read_line_buffer)
        0 : begin
            ...
            data_out = {line_buf_0_data_out,line_buf_1_data_out};
        end
        1 : begin
            // data_out = {line_buf_3_data_out,line_buf_2_data_out,line_buf_1_data_out};
            data_out = {line_buf_1_data_out,line_buf_2_data_out};
        end
        2 : begin
            // data_out = {line_buf_0_data_out,line_buf_3_data_out,line_buf_2_data_out};
            data_out = {line_buf_2_data_out,line_buf_0_data_out};
        end
        // 3 : begin
